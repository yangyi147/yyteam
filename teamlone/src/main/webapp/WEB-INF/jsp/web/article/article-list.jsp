									...
									<c:forEach var="article" items="${list }">
										<li>
											<aside class="i-article-pic">
												<img xSrc="<%=staticImage%>${article.image_url }" src="${ctx }/static/inxweb/img/default-img.gif" alt="${article.title }">
											</aside> <!-- ${ctx }/web/article/showInfor/${article.article_id } -->
											<h3 class="hLh30 txtOf">
												<a href="${ctx }/front/articleinfo/${article.article_id}.html" title="${article.title }" class="i-art-title">${article.title }</a>
											</h3>
											...
											<section class="hLh30 txtOf mt5 pr10 a-list-extrainfo">
												...
												<div class="fl">
													<span> <a class="noter-dy vam" title="回答" href="${ctx }/front/articleinfo/${article.article_id}.html">
															...
															<em class="icon18">&nbsp;</em>(<span class="addPraise${article.article_id}_3 praiseCount">${article.praise_count }</span>)
														</tt>
													</span>
												</div>
											</section>
