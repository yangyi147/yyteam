				...
				<div class="fl col-7">
					<section class="mr30">
						<section class="path-wrap txtOf hLh30">
							<a href="${ctx }/front" title="首页" class="c-999 fsize14">首页</a>
							\
							<a href="${ctx}/front/article" title="" class="c-999 fsize14">文章列表</a>
							\ <span class="c-333 fsize14">${eac.edu_article.title }</span>
						</section>
						<article class="article-infor-box pr20">
							<h3 class="hLh30 txtOf">
								<span class="i-art-title">${eac.edu_article.title }</span>
							</h3>
							<section class="hLh30 txtOf mt5 pb20 mreadnum">
								...
								<div class="fl pt3"><%--  <tt class="c-999 f-fM">来源：${article.source }</tt>  --%><tt class="c-999 f-fM">
										<!-- 1小时前发布 -->
										<fmt:formatDate value="${eac.edu_article.publish_time }" pattern="yyyy-MM-dd HH:mm" />
								</tt>
								</div>
							</section>
