												...
												<c:forEach items="${parentKpointList }" var="parentKpoint" varStatus="index">
													<c:if test="${parentKpoint.kpoint_type==0 }"><!-- 文件目录 -->
															<li class="lh-menu-stair">
																...
																>
																	<c:forEach items="${parentKpoint.sonList}" var="sonKpoint">
										...
										<c:forEach items="${sunjectNextAllCourse }" var="interfixCourse">
											<li>
												...
												<section class="hLh20 mt5 txtOf">
													<span class="c-999">讲师：
														<c:if test="${interfixCourse.teacher!=null && interfixCourse.teacher.size()>0}">
...
<script type="text/javascript" src="${ctx}/static/common/jquery-1.11.1.min.js"></script>
	...
	<script type="text/javascript" src="${ctx }/static/inxweb/js/commons.js" ></script>
	<script src="/static/inxweb/comment/comments.js" type="text/javascript"></script><!-- 评论js -->
	...
	$(function () {
		...
		if(currentKpointId!=0){
			getPlayerHtml(currentKpointId,name,null,0);
		}else{
			getPlayerHtml(currentKpointId,name,null,otherId);
		}
	})
	</script>
</body>
