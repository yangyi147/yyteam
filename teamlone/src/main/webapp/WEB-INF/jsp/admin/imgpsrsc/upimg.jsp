...
<body>
	...
	<div class="larry-personal">
		<header class="larry-personal-tit"> <span>修改图片信息</span> </header>
		<!-- /header -->
		<div class="larry-personal-body clearfix">
			<form class="layui-form col-lg-5" action="/admin/upload/img"
				...
				<div class="layui-form-item">
					...
					<div id="cp6" class="input-group colorpicker-component"
						...
						<input type="text" class="form-control input-lg" name="color"
							value="${im.color }" /> <span class="input-group-addon"><i></i></span>
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<img src="/images/img/${im.image_url}" width="300" height="200" id="img" /> 
