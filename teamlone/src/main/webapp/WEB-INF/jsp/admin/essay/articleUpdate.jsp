...
<body>
	...
	<div class="larry-personal">
		...
		<div class="larry-personal-body clearfix">
			<form class="layui-form col-lg-5" action="/admin/updateadd"
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="author" id="author" class="form-control"
							value="${eacget.edu_article.author}">
					</div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="source" id="source" class="form-control"
							value="${eacget.edu_article.source}">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<table>
							<tr>
								<td><image id="blah"
										src="${eacget.edu_article.image_url } "
										style="width:300px; height:150px;" /> <input type="hidden"
									name="hiddens" value="${eacget.edu_article.image_url } ">
								</td>
								<td><input type="file"
									value="${eacget.edu_article.image_url }" name="file"
									id="imgInp"></td>
							</tr>
						</table>
					</div>
            ...
            ${eacget.content }
				...
				<div class="layui-form-item">
					<div class="layui-input-block">
	<shiro:hasPermission name="/admin/article/updatearticle/2">
	...
	<script type="text/javascript">
		...
		{
			toolbars : [
					[ 'fontfamily', 'fontsize', 'undo', 'redo', '|', 'emotion',
							'forecolor', 'backcolor', 'bold', 'underline',
							'strikethrough', '|', 'justifyleft',
							'justifyright', 'justifycenter', 'link', 'unlink',
